...
// ║  • 7 кнопок: 3 полива, увлажнитель и насос (нажатие) +          ║
// ║    «Открыть» и «Закрыть» форточек (удержание).                  ║
// ║  • DHT22 на GPIO13, TRIG ультразвука на GPIO0, датчик дождя —   ║
// ║    аналоговый на GPIO36 (ADC1).                                  ║
// ║                                                                  ║
